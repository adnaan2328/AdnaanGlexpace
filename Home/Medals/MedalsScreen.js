...
export default class ImageScreen extends Component {
  ...
  showAlert = (number) => {
    this.dropDownAlertRef.alertWithType(
      "warn",
      `Post ${number} stories to unlock the badge.`
    );
  };
              ...
              <View style={{ flex: 1, padding: 10 }}>
                ...
                >
                  {this.state.numberOfpostes >= 5 ? (
                    <View style={{ height: 120, width: 120 }}>
                      <Image
                        source={require("./BadgeImages/b1.jpeg")}
                    ...
                    >
                      <Image
                        source={require("./BadgeImages/b1L.jpg")}
                        style={styles.badgeImages}
                      />
                      <View
                        style={{
                  ...
                  {this.state.numberOfpostes >= 59 ? (
                    <View style={{ height: 120, width: 120 }}>
                      <Image
                        source={require("./BadgeImages/b2.jpeg")}
                        style={styles.badgeImages}
                      />
                    </View>
                  ) : (
                    ...
                    >
                      <Image
                        source={require("./BadgeImages/b2L.jpg")}
                        style={styles.badgeImages}
                      />
                    </TouchableOpacity>
                  )}
                ...
                >
                  {this.state.numberOfpostes >= 199 ? (
                    <View style={{ height: 120, width: 120 }}>
                      <Image
                        source={require("./BadgeImages/b3.jpeg")}
                        style={styles.badgeImages}
                      />
                    </View>
                  ) : (
                    ...
                    >
                      <Image
                        source={require("./BadgeImages/b3L.jpg")}
                        style={styles.badgeImages}
                      />
                    </TouchableOpacity>
                  )}
                  {this.state.numberOfpostes >= 449 ? (
                    <View style={{ height: 120, width: 120 }}>
                      <Image
                        source={require("./BadgeImages/b4.jpeg")}
                        style={styles.badgeImages}
                      />
                    </View>
                  ) : (
                    ...
                    >
                      <Image
                        source={require("./BadgeImages/b4L.jpg")}
                        style={styles.badgeImages}
                      />
                    </TouchableOpacity>
                  )}
